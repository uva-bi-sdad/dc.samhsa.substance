---
title: "catchment_scores - substance abuse - VA"
author: "--"
date: "2/4/2022"
...
provider <- sf::st_read(
  ...
  query= "
SELECT  *
FROM dc_health_behavior_diet.va_pl_samhsa_2021_substance_use_facilities
WHERE state = 'VA' "
)
...
#write
write.csv(provider, "substance_abuse_va.csv" )
