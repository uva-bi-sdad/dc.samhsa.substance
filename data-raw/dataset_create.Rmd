...
dataset:
  citation:
      title: "Social Data Commons: Health, Behavior, Diet: Substance Abuse Treatment Facilities Access Scores"
      subtitle: ""
      dsDescriptionValue: "Access Scores for Substance Abuse Treatment Facilities located in the National Capital Region NCR given by the Floating Catchment Areas"
  ...
  geospatial:
    geographicCoverage:
      ...
      state: "Virginia, District of Columbia, Maryland (NCR)"
    geographicUnit:
      - "County"
      - "Census tract"
      - "Block group"
